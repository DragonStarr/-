    ...
    async def collect_actions(self, ctx: TenantContext, replay: ReplayHub) -> list[TaskAction]:
        ...
        return [
            _action(
                ...
                rule_change_id=_record_text(change, "id", default="safe-test-rule"),
    ...
    async def collect_actions(self, ctx: TenantContext, replay: ReplayHub) -> list[TaskAction]:
        ...
        return [
            _action(
                ...
                confidence=confidence_from_inputs(source_count=len(cash_ops) + len(receipts)),
                cash_operation_id=_record_text(cash, "id", default="safe-test-cash"),
                receipts_count=len(receipts),
        ...
        if spec:
            ...
            return [
                _action(
                    ...
                    studio_spec_id=_record_text(spec, "id", default="safe-test-studio"),
    ...
    async def collect_actions(self, ctx: TenantContext, replay: ReplayHub) -> list[TaskAction]:
        ...
        return [
            _action(
                ...
                incident_id=_record_text(incident, "id", default="safe-test-supervisor"),
                severity=severity,
                status=status,
    ...
    async def collect_actions(self, ctx: TenantContext, replay: ReplayHub) -> list[TaskAction]:
        ...
        return [
            _action(
                ...
                eval_run_id=_record_text(eval_row, "id", default="safe-test-eval"),
                eval_score=score,
    ...
    async def collect_actions(self, ctx: TenantContext, replay: ReplayHub) -> list[TaskAction]:
        ...
        return [
            _action(
                ...
                source_change_id=_record_text(change, "id", default="safe-test-source"),
                source_url=_record_text(change, "source_url", "url"),
