...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE semantic_memory (
            ...
            embedding_model VARCHAR(120) NOT NULL DEFAULT 'bge-m3-local',
    ...
    op.create_index("ix_semantic_memory_scope", "semantic_memory", ["scope"])
    op.create_index("ix_semantic_memory_text_hash", "semantic_memory", ["text_hash"])
    op.execute(
        """
        CREATE INDEX ix_semantic_memory_vector_hnsw
        ON semantic_memory
